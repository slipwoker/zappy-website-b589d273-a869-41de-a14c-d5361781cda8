document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        var messages = isRTL ? rtlErrorMessages : errorMessages;
        ...
        function validateField(input) {
            var fieldName = input.getAttribute('name') || input.getAttribute('data-name');
            var value = input.value.trim();
            
            if (!value) {
                showError(input, messages[fieldName] || 'This field is required');
                return false;
            }
            ...
            if (isValid) {
                ...
                setTimeout(function() {
                    if (submitBtn) {
                        ...
                        submitBtn.textContent = isRTL ? 'تم الإرسال!' : 'Sent!';
                    }
                    contactForm.reset();
                    
                    setTimeout(function() {
                        if (submitBtn) {
                            submitBtn.textContent = isRTL ? 'إرسال' : 'Submit';
                        }
                    }, 3000);
                }, 1500);
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b589d273-a869-41de-a14c-d5361781cda8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b589d273-a869-41de-a14c-d5361781cda8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b589d273-a869-41de-a14c-d5361781cda8';
